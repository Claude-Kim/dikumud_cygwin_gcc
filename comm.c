...
extern char help[]; /* In db.c */
extern bool wizlock; /* In db.c */
...
int shutdown_num = 0;    /* clean shutdown_num */
int reboot_num = 0;      /* reboot_num the game after a shutdown_num */
...
int run_the_game(int port)
{
	...
	void signal_setup(void); /* extern in signal.c */
	int load(void); /* extern in modify.c */
